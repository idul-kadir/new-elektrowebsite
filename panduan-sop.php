<?php
// panduan-sop.php — Halaman Dokumen Panduan dan SOP
$pageTitle = 'Panduan dan SOP — Jurusan Teknik Elektro dan Komputer';
    ...
    <div class="container">
        <div>
            <div class="breadcrumb">
                ...
                <a href="#">Akademik</a> &rsaquo;&nbsp; Panduan dan SOP
            </div>
            <h1>Panduan dan SOP</h1>
            <p class="lede">Dokumen panduan dan Standar Operasional Prosedur (SOP) Jurusan Teknik Elektro dan Komputer, Fakultas Teknik UNG.</p>
        </div>
    ...
    <div class="container">
        <div class="section-head section-head-split">
            ...
            <div class="section-head-right">
                <h2 class="section-title">Panduan &amp; SOP</h2>
            </div>
        </div>
...
<script>
// Fetch + render dokumen Panduan dan SOP
(async function() {
    ...
    try {
        ...
        // filter kategori Panduan dan SOP
        allItems = Array.isArray(data) ? data.filter(d => d.kategori === 'Panduan dan SOP') : [];
