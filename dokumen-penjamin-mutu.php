<?php
// dokumen-penjamin-mutu.php — Halaman Dokumen Penjamin Mutu
$pageTitle = 'Dokumen Penjamin Mutu — Jurusan Teknik Elektro dan Komputer';
    ...
    <div class="container">
        <div>
            <div class="breadcrumb">
                ...
                <a href="#">Akademik</a> &rsaquo;&nbsp; Dokumen Penjamin Mutu
            </div>
            <h1>Dokumen Penjamin Mutu</h1>
            <p class="lede">Dokumen sistem penjaminan mutu internal Jurusan Teknik Elektro dan Komputer, Fakultas Teknik UNG.</p>
        </div>
    ...
    <div class="container">
        <div class="section-head section-head-split">
            ...
            <div class="section-head-right">
                <h2 class="section-title">Penjamin Mutu</h2>
            </div>
        </div>
        <p class="section-desc" style="margin-top:-32px;margin-bottom:32px;max-width:760px;">
            Pilih kategori tahun atau gunakan kotak pencarian untuk menemukan dokumen yang Anda butuhkan.
        </p>
...
<script>
// Fetch + render dokumen Penjamin Mutu
(async function() {
    ...
    try {
        ...
        // filter kategori Penjamin Mutu
        allItems = Array.isArray(data) ? data.filter(d => d.kategori === 'Penjamin Mutu') : [];
